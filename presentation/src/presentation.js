    ...
    return (
      ...
      >
        ...
        <Slide bgImage={images.past.replace("/", "")}>
          <Heading fit bgColor="black" textColor="secondary">Let's go back to the past</Heading>
        </Slide>
        <Slide>
        ...
        <Slide>
          <Image fit src={images.renderers.replace("/", "")} height="580" margin={0}/>
          <Cite>https://github.com/chentsulin/awesome-react-renderer</Cite>
        </Slide>
        <Magic>
        ...
        <Slide>
          <Image fit src={images.reactar.replace("/", "")} height="580" margin={0}/>
      ...
      <View>
        ...
        <Slide bgColor="black" textColor="secondary">
          ...
          <List>
            ...
            <Appear><ListItem>... and also - Flexbox!</ListItem></Appear>
          </List>
        </Slide>
        <Slide bgColor="black">
          <Heading size={2} fit textColor="secondary" textFont="primary">
